...
export function MailIndex() {
    ...
    function changeCategoryByRouteParams() {
        ...
        if (params.category === 'starred' && filterBy.isStarred !== true) setFilterBy({ ...filterBy, isInbox: false, isStarred: true, isSent: false, isDraft: false, isTrash: false,  all: false })
        if (params.category === 'sent' && filterBy.isSent !== true) setFilterBy({ ...filterBy, isInbox: false, isStarred: false, isSent: true, isDraft: false, isTrash: false, all: false })
        if (params.category === 'draft' && filterBy.isDraft !== true) setFilterBy({ ...filterBy, isInbox: false, isStarred: false, isSent: false, isDraft: true, isTrash: false, all: false })
        if (params.category === 'trash' && filterBy.isTrash !== true) setFilterBy({ ...filterBy, isInbox: false, isStarred: false, isSent: false, isDraft: false, isTrash: true, all: false })
        if (params.category === 'all' && filterBy.all !== true) setFilterBy({ ...filterBy, isInbox: false, isStarred: false, isSent: false, isDraft: false, isTrash: false, all: true })
    }
